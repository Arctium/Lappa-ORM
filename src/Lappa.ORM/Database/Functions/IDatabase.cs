...
namespace Lappa.ORM
{
    ...
    public interface IDatabase
    {
        ...
        ValueTask<int> Delete<TEntity>(Expression<Func<TEntity, object>> condition) where TEntity : IEntity, new();
        ...
        ValueTask<int> Update<TEntity>(Expression<Func<TEntity, bool>> condition, params Expression<Func<TEntity, object>>[] setExpressions) where TEntity : IEntity, new();
        ValueTask<int> Update<TEntity>(TEntity entity) where TEntity : IEntity, new();
        ValueTask<int> UpdateAll<TEntity>(params Expression<Func<TEntity, object>>[] setExpressions) where TEntity : IEntity, new();
